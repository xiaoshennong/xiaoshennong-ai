...
SYMPTOM_MAP = {
    ...
    'SN-TH-S-004': {'name': '胃脘痛', 'aliases': ['胃脘痛', '胃痛', '胃疼', '心下痛', '脘腹痛'], 'classic_refs': ['伤寒论', '金匮要略']},
    'SN-TH-S-005': {'name': '腹胀', 'aliases': ['腹胀', '腹满', '肚子胀', '脘腹胀满'], 'classic_refs': ['伤寒论', '金匮要略']},
    ...
    'SN-TH-S-012': {'name': '食欲不振', 'aliases': ['食欲不振', '不欲食', '不能食', '纳呆', '纳差'], 'classic_refs': ['伤寒论', '金匮要略']},
